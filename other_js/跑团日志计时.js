...
function generateStorageLogRegistryKey(groupId) {
  return "LOG_TIMER_REGISTRY_" + groupId;
}
function updateLogRegistry(extInfo, groupId, logName) {
  var registryKey = generateStorageLogRegistryKey(groupId);
  var json = Seal.storageGet(extInfo, registryKey);
  var arr;
  if (json !== void 0 && json !== "") {
    arr = JSON.parse(json);
  } else {
  ...
  var json$1 = JSON.stringify(arr);
  if (json$1 !== void 0) {
    extInfo.storageSet(registryKey, json$1);
  }
}
function getLastActiveLog(extInfo, groupId) {
  var registryKey = generateStorageLogRegistryKey(groupId);
  var json = Seal.storageGet(extInfo, registryKey);
  if (json === void 0 || json === "") {
    return;
...
function logBegin(extInfo, msgContext, groupId) {
  ...
  if (json !== void 0 && json !== "") {
    ...
    if (json$1 !== void 0) {
      ...
      updateLogRegistry(extInfo, groupId, logName);
      return {
        TAG: "Ok",
        _0: {
          new: false,
    ...
    switch (exit$1) {
      case 1:
        ...
        if (arg1 !== void 0 && arg1 !== "") {
          ...
          var lastLog = getLastActiveLog(ext, message.groupId);
          if (lastLog !== void 0) {
            logNameToUse = lastLog;
          } else {
            logNameToUse = Dayjs().format("YYYY-MM-DD");
          }
        }
        Seal.Vars.strSet(msgContext, "$t记录名称", logNameToUse);
      ...
      case 2:
        ...
        if (arg1 !== void 0 && arg1 !== "") {
          ...
          var lastLog$1 = getLastActiveLog(ext, message.groupId);
          if (lastLog$1 !== void 0) {
            logNameToUse$1 = lastLog$1;
          } else {
            logNameToUse$1 = Dayjs().format("YYYY-MM-DD");
          }
        }
        Seal.Vars.strSet(msgContext, "$t记录名称", logNameToUse$1);
