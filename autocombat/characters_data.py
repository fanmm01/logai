...
SUMMON_TEMPLATES = {
    ...
    '龙虎': {
        ...
        '闪避': 40, 'MOV': 8, '行动次数': 2, '可反击': 1, '可反应': 1,
        'skills': [
    ...
    'spells':[
        {
            ...
            'effects':[{
                'type':1, '客体':4, '伤害骰':'1d12+4+1d3', '成功率':75, '可反应性':0,
...
XUETIANSHI = {
    'name':'血天使', 'serial':'Y5',
    'attrs':{
        '等级':5, '敏捷':80, '体力':8, '体力上限':8, '魔力':14, '魔力上限':14,
    ...
    'spells':[
        ...
        },
        {
            ...
            'effects':[{
                'type':1, '客体':4, '伤害骰':'2d3+1d6+2', '可反应性':1, '吸血比例':'1.0',
            }]
        },
    ]
}
...
BIHAMI = {
    ...
    'spells':[
        {
            'name':'美味的蛋糕', 'timing':'3', 'category':6, '消耗mp':2,
            'effects':[{'type':6, '客体':1, '制造个数':1, '制造花费回合数':0, '制造物模板':'蛋糕HP'}]
        },
        {
            'name':'甜甜的蛋糕', 'timing':'3', 'category':6, '消耗mp':2,
            'effects':[{'type':6, '客体':1, '制造个数':1, '制造花费回合数':0, '制造物模板':'蛋糕MP'}]
        },
    ]
}
...
MULUO = {
    ...
    'spells':[
        ...
        {'name':'生之矛', 'phase':1, 'timing':'2', 'category':1,
         'effects':[{'type':1, '客体':4, '伤害骰':'4d6', '成功率':70, '可反应性':1,
...
CHUNSHANG = {
    ...
    'spells':[
        ...
        },
        {
            ...
            'effects':[{'type':5, '客体':1, '召唤个数':'1d6', '召唤物模板':'蜂鸟', '持续回合':99}]
        },
    ]
}
