...
MAIZHIXIA = {
    ...
    'initial_phase': 2,
    'attrs': {
        '等级': 2, '敏捷': 65, '体力': 14, '体力上限': 14, '魔力': 10, '魔力上限': 10,
...
YUCHANGFENG = {
    'name': '于长风', 'serial': 'Y15',
    'attrs': {
        '等级': 2, '敏捷': 65, '体力': 13, '体力上限': 13, '魔力': 10, '魔力上限': 10,
...
LINBAI = {
    'name': '林白', 'serial': 'Y16',
    'attrs': {
        '等级': 2, '敏捷': 70, '体力': 12, '体力上限': 12, '魔力': 16, '魔力上限': 16,
...
YEZHAOMING = {
    ...
    'spells': [
        ...
        {'name': '阿瑞卡纳律动', 'timing': '2', 'category': 1, '吟唱回合': 3,
         ...
         'effects': [
             {'type': 1, '客体': 4, '伤害骰': '1d1', '成功率': 80, '可闪避性': 1, '可反击性': 0,
              ...
              'blood_per_hit_ml': 0},  # blood_per_hit computed from _actual_mp_cost × 50
         ]},

        # s3: 凝血式-守（血液→护甲，无血则50%HP→2×护甲）
        {'name': '凝血式-守', 'timing': '3', 'category': 2, '消耗mp': 0,
         'cost_blood_ml': 300,  # 300ml = 1 armor (minimum)
         'effects': [
             {'type': 2, '客体': 1, '护盾值': '1', '持续回合': 99},
         ]},

        # s4: 祭炼式-破（2回合可打断吟唱，90%caster最大HP伤害）
        ...
        # s5: 凝血式-幻（血液→武器创造，每100ml=1部件）
        {'name': '凝血式-幻', 'timing': '3', 'category': 5, '消耗mp': 0,
         'cost_blood_ml': 100,  # Minimum blood per component
         'effects': [
             {'type': 5, '客体': 1, '召唤个数': 1, '召唤物模板': '血液构造物', '持续回合': 999},
         ]},

        # s6: 污血战争（AOE 2d12，击杀回复+吸血，连锁）
        ...
        {'name': '血染披风', 'timing': '2', 'category': 3, '消耗mp': 0,
         'cost_blood_ml': 1000,
         'effects': [
             {'type': 3, '客体': 1, '回复mp': '1d6+2'},
         ]},

        # s11: 血月斩击（随机月相，伤害+吸血变化）
...
X1 = {
    ...
    'spells':[
        ...
        # ── Y11 双技能 ──
        {'name':'挥动镰刀', 'timing':'2', 'category':1, '消耗mp':2,
         'effects':[{'type':1, '客体':4, '伤害骰':'1d10+2d6+3', '成功率':80,
                      '可闪避性':1, '可反击性':1, '射程':2,
                      '辅助效果':'技能惩罚骰', '辅助效果值':'p', '吸血比例':'0.35'}]},
        {'name':'黑雾笼罩', 'timing':'2', 'category':8, '消耗mp':3,
         'effects':[
             {'type':8, '客体':45, '作用半径':8, '持续回合':3, '属性削减':'闪避-16', '领域中心跟随':1,
              'on_enter_mp_drain_pct': 0.4, 'on_enter_attr_debuff': '闪避-10', 'on_enter_trigger_rate': 0.5},
             {'type':4, '客体':5, '持续回合':3, '辅助效果':'伤害成功率奖励惩罚', '辅助效果值':'p'},
             {'type':4, '客体':1, '持续回合':3, '辅助效果':'伤害成功率奖励惩罚', '辅助效果值':'b'},
             {'type':4, '客体':1, '持续回合':3, '技能加减值':'MOV+5'},
         ]},
    ]
}
...
ALL_CHARACTERS = [
    ...
    MAIZHIXIA, YUCHANGFENG, LINBAI, YEZHAOMING, X1
]
